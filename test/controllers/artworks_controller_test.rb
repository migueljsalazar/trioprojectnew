...
class ArtworksControllerTest < ActionController::TestCase
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post :create, artwork: { description: @artwork.description, location: @artwork.location, style: @artwork.style, title: @artwork.title }
    end
  ...
  test "should update artwork" do
    patch :update, id: @artwork, artwork: { description: @artwork.description, location: @artwork.location, style: @artwork.style, title: @artwork.title }
    assert_redirected_to artwork_path(assigns(:artwork))
  end
